...
import logo from '@assets/images/White_Wordmark.png';
      ...
      */}
          <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-blue-600">
            ...
            <div className="flex-shrink-0 flex items-center px-4">
              <img className="w-1/2" src={logo} alt="Passable logo" />
            </div>
            <div className="mt-5 overflow-y-auto">
              <nav className="px-2 space-y-1">
                <a
                  href="/"
                  className="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white bg-blue-700 focus:outline-none focus:bg-blue-500 transition ease-in-out duration-150">
                  {/* Heroicon name: home */}
                  <svg
                    className="mr-4 h-6 w-6 text-blue-200 transition ease-in-out duration-150"
                ...
                <a
                  href="/"
                  className="group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-blue-100 hover:text-white hover:bg-blue-500 focus:outline-none focus:bg-blue-500 transition ease-in-out duration-150">
                  {/* Heroicon name: clock */}
                  <svg
                    className="mr-4 h-6 w-6 text-blue-200 transition ease-in-out duration-150"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <hr className="h-px mt-6 bg-blue-700 border-none" />
            <div className="mt-6 flex-1 h-0 overflow-y-auto">
              <nav className="px-2 space-y-1">
                <a
                  ...
                  {/* Heroicon name: cog */}
                  <svg
                    className="mr-4 h-6 w-6 text-blue-200 group-hover:text-blue-200 group-focus:text-blue-200 transition ease-in-out duration-150"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor">
                ...
                <a
                  ...
                  <svg
                    className="mr-4 h-6 w-6 text-blue-300 group-hover:text-blue-200 group-focus:text-blue-200 transition ease-in-out duration-150"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor">
        ...
        <div className="flex flex-col w-64">
          ...
          <div className="flex flex-col flex-grow bg-blue-600 pt-5 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-4">
              <img className="h-12 w-auto" src={logo} alt="Passable logo" />
            </div>
            <div className="mt-5 flex-1 flex flex-col overflow-y-auto">
              <div className="overflow-y-auto">
                <nav className="px-2 space-y-1">
                  <a
                    href="/"
                    className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-white bg-blue-700 focus:outline-none focus:bg-blue-500 transition ease-in-out duration-150">
                    {/* Heroicon name: home */}
                    <svg
                      className="mr-4 h-6 w-6 text-blue-200 group-hover:text-blue-200 group-focus:text-blue-200 transition ease-in-out duration-150"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    href="/"
                    className="group flex items-center px-2 py-2 text-sm leading-6 font-medium rounded-md text-blue-100 hover:text-white hover:bg-blue-500 focus:outline-none focus:bg-blue-500 transition ease-in-out duration-150">
                    {/* Heroicon name: clock */}
                    <svg
                      className="mr-4 h-6 w-6 text-blue-300 group-hover:text-blue-200 group-focus:text-blue-200 transition ease-in-out duration-150"
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="bg-white overflow-hidden shadow rounded-lg">
                  ...
                  <div className="bg-cool-gray-50 px-5 py-3">
                    <div className="text-sm leading-5">
                      <a
                        href="/"
                        className="font-medium text-blue-600 hover:text-blue-900 transition ease-in-out duration-150">
                        View all
                      </a>
                    </div>
                  </div>
